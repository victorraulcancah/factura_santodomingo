                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-2">
                                                                                <button @click="addProduct" type="button" class="btn btn-success"
                                                                                    ...
                                                                                    :title="puedeAgregarCompra === false ? 'Elige presentación primero' : ''">
    ...
    $(document).ready(function() {
        ...
        var app = new Vue({
            ...
            computed: {
                puedeAgregarCompra() {
                    ...
                    // Si el producto tiene unidad derivada, debe escoger presentación
        ...
        $("#descripcionBuscar").autocomplete({
            ...
            select: function(event, ui) {
                ...
                // Si SÍ tiene ? vacío para forzar selección.
